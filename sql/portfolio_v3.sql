...
(13, 'Number To Word', '', '', 'http://project.nfraz.co.in/number_to_word/', 'https://nfraz007.github.io/number_to_word/', 'This is a php script which basically convert a input number to word form. Add this library into your project and just call a function convert(), thats it. Read the documentation for more detail.', 'PHP', '2017-05-01 12:00:00', '2017-05-02 12:00:00', 1, '2018-08-10 12:00:00'),
(14, 'Portfolio v3', '', '', 'https://nfraz.co.in', 'https://github.com/nfraz007/portfolio_v3', 'This is the third version of my portfolio website. In this project I am using codeigniter. This is a opensource project so any one can use this project for creating a portfolio. This is fully dynamic and every data is coming from database.', 'Codeigniter,Mysql,JSON,HTML,CSS,SASS,Bootstrap,Jquery', '2018-08-01 12:00:00', '2018-08-20 12:00:00', 1, '2018-08-10 12:00:00'),
(15, 'Blood Bank', '', '', 'http://project.nfraz.co.in/blood_bank', 'https://nfraz007.github.io/blood_bank/', 'I got this project when I was applying to internshala. I had to create a small blood bank website in PHP.', 'HTML,CSS,Bootstrap,Javascript,Jquery,JSON,PHP,Mysql', '2017-07-01 12:00:00', '2017-07-10 12:00:00', 1, '2018-08-10 12:00:00'),
...
INSERT INTO `nf3_project` (`project_id`, `experience_id`, `project_type`, `project_name`, `project_icon`, `project_image`, `project_demo`, `project_url`, `project_detail`, `technology`, `start_at`, `end_at`, `project_status`, `created_at`) VALUES (NULL, NULL, 'PERSONAL', 'Danish Portfolio v1', '', '', 'http://gouherdanish.c1.biz', 'https://github.com/nfraz007/danish_portfolio_v1', 'One acquaintance who is a data scientist wanted a portfolio website where he can show his work and project. I made a single page application in Vue JS and google firebase. this portfolio is fully dynamic and everything can be modified in the firebase database.', 'Vue JS, Firebase, Axios, HTML, SCSS, Bootstrap', '2019-03-01 00:00:00', '2019-03-10 00:00:00', '1', '2019-04-18 00:00:00');
...
INSERT INTO `nf3_project` (`project_id`, `experience_id`, `project_type`, `project_name`, `project_icon`, `project_image`, `project_demo`, `project_url`, `project_video`, `project_detail`, `technology`, `start_at`, `end_at`, `project_status`, `created_at`) VALUES (NULL, NULL, 'PERSONAL', 'Dinars Invoice', '', '', 'http://invoice.nfraz.co.in/', '', NULL, 'This is an invoice software made in laravel and vue js in material theme. It is very easy to create an invoice and download it. Managing multiple companies, generate material theme invoice in pdf, reports are some features. ', 'Laravel,Mysql,HTML,SASS,Vuetify,Vue JS, Axios,DOM PDF', '2019-07-01 12:00:00', '2019-08-30 12:00:00', '1', '2018-12-02 00:00:00');
